...
const Login: React.FC<SignupProps> = ({ providers }) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    const response = await fetch("https://carbon-relay-backend2.vercel.app/api/login", {
      method: "POST",
      headers: {
  ...
  return (
    ...
    <div  className="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        >
          <path
            d="M14,0H2A2,2,0,0,0,0,2V14a2,2,0,0,0,2,2H14a2,2,0,0,0,2-2V2A2,2,0,0,0,14,0ZM4.55,13.37H2V6.45h2.53ZM3.78,5.12A1.67,1.67,0,1,1,5.45,3.44,1.68,1.68,0,0,1,3.78,5.12ZM13.37,13.37H10.84V10.42c0-1.13-.4-1.91-1.4-1.91-1.4,0-2.24,1.13-2.24,2.8v2.07H5.45V6.45h2.53V7.77h.03c.35-.6,1.2-1.23,2.47-1.23,2.64,0,4.68,1.73,4.68,5.47Z"
          />
        </svg>
        </>
      ) : provider.id === "github" ? (
